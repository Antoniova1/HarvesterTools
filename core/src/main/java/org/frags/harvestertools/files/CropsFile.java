...
public class CropsFile {
    ...
    public CropsFile(HarvesterTools plugin) {
        this.plugin = plugin;
        saveDefaultConfig();
    }
    ...
    public void reloadConfig() {
        if (this.configFile == null)
            this.configFile = new File(plugin.getDataFolder(), "crops.yml");

        dataConfig = YamlConfiguration.loadConfiguration(configFile);

        InputStream defaultStream = plugin.getResource("crops.yml");
