...
public class MobSwordUtils {
    ...
    public MobSwordUtils(HarvesterTools plugin) {
        this.plugin = plugin;
        this.enchantsManager = plugin.getEnchantsManager();
        this.configuration = plugin.swordEnchantsFile.getConfig();
    ...
    public void manageSharpness(EntityDamageByEntityEvent e, ItemStack itemStack) {
    ...
    public void procHaste(Player player, ItemStack itemStack) {
        ...
        CustomEnchant haste = enchantsManager.getEnchant("haste", Tools.sword);
        if (haste == null)
            return;
    ...
    public void procStrength(Player player, ItemStack itemStack) {
        UUID playerUUID = player.getUniqueId();
        ...
        if (lastStrenghtTime.containsKey(playerUUID)) {
            long lastTime = lastStrenghtTime.get(playerUUID);
        ...
        lastStrenghtTime.replace(playerUUID, currentTime);
    }
